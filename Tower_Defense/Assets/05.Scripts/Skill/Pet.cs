...
public class Pet : MonoBehaviour
{
    ...
    private SkillLevelStat currentPetStat;
    ...
    /// </summary>
    public void UpgradePet(int level, SkillLevelStat stat)
    {
        currentPetStat = stat;
        // 펫 이펙트나 각 종 설정들 추가 v
    ...
    // Player.cs와 동일한 내부 스킬 레벨업 로직
    public bool LevelUpPetSkill(string skillName)
    {
        int newLevel = -1;
